...
static int parse_status_line(const char *buf)
{
    ...
    if (strncmp(buf, "HTTP/1", 6) != 0) return -1;
...
const char *http_error_str(HttpErrorType e)
{
    switch (e) {
        ...
        case HTTP_ERR_CONNECT: return "connection_refused";
        case HTTP_ERR_DNS:     return "dns_failure";
        case HTTP_ERR_SSL:     return "tls_error";
        case HTTP_ERR_PROTO:   return "protocol_error";
        case HTTP_ERR_SYSTEM:  return "system_error";
